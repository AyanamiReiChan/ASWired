...
`djgun-spacecube.mp4` and `djgun-spacecube.jpg` (current background):
- Wallpaper: DJGun&SpaceCube50 Remake, Steam Workshop item 3714466840.
- Source: https://steamcommunity.com/sharedfiles/filedetails/?id=3714466840
- Extracted the embedded MP4 from `scene.pkg` → `materials/DJGun aN3.tex`.
